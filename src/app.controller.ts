...
export class AppController {
  ...
  @Get()
  async startApp(
    @Body() body: { nombre: string; api: string },
  ): Promise<object> {
    if (body.api === 'BC55BaxW6PtcvACZBKv5IoCugEokpGQC') {
      ...
      if (body.nombre !== undefined) {
            ...
            if (
              ...
              const element = {
                ...
                valor:
                  responseLiderCl.data[i].stores[
                    `${
                      JSON.stringify(responseLiderCl.data[i].stores).split(
                        '"',
                      )[1]
                    }`
                  ].prices.sale,
          ...
          for (let i = 0; i < responseDiaAr.data.length; i++) {
            if (
              ...
              const element = {
                ...
                valor:
                  responseDiaAr.data[i].items[0].sellers[0].commertialOffer
                    .Price,
                pais: 'ARGENTINA',
                id: this.idGenerator(),
              };
        ...
        try {
          ...
          for (let i = 0; i < responseWongPe.data.length; i++) {
            if (
              responseWongPe.data[i].items[0].sellers[0].commertialOffer.Price >
              0
            ) {
              const element = {
        ...
        try {
          ...
          for (let i = 0; i < responseTataUy.data.length; i++) {
            if (
              responseTataUy.data[i].items[0].sellers[0].commertialOffer.Pricu >
              0
            ) {
              const element = {
      ...
      return { response: 'Invalid apikey' };
    }
  }
